...
- [x] Chaque champ de saisie mobile possède un nom accessible explicite ; chaque commande uniquement iconique possède un rôle et un libellé ; un contrat Vitest empêche leur régression.
